...
A doctor can't cure a disease he can't identify — a PCB isn't any different.
 Electroscan is built on that instinct: know the fault before you touch the board.
